                        ...
                        <table id="dataTable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.sertifikat.detailtrainer', ['id' => $data->id_pelatihan]) }}" class="btn btn-sm btn-warning" target="_blank" data-toggle="tooltip" title="Cetak"><i class="fa fa-print"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
